	...
	<div class="col-md-offset-4 col-md-4">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<?php
				echo form_open_multipart('home/login',[ 'class' => 'form' ]);
				?>
				...
				<div class="form-group">
					<div class="col-md-12 text-center" style="padding:10px;">
						<?php
						$att = ['class' => 'btn btn-primary', 'value' => 'Login'];
						echo form_submit($att);
						?>
						<a class="btn btn-info" href="<?php echo base_url(); ?>index.php/home/register">Daftar</a>
					</div>
				</div>
				<?php 
					echo form_close();
